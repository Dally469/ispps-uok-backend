...
insert into users (id, email, full_name, role, password_hash, school_id) values
  ...
  ('c0000000-0000-0000-0000-000000000002', 'drsilva@uok.lk', 'Dr. Kamal Silva', 'teacher', '$2b$10$jmX9QF7SmhpTc7fqc1lpR.KpcR0FpvRFH6bTLdtOv4SJHRGng/PeW', 'a0000000-0000-0000-0000-000000000001'),
  ('c0000000-0000-0000-0000-000000000003', 'drperera@uok.lk', 'Dr. Nimali Perera', 'teacher', '$2b$10$jmX9QF7SmhpTc7fqc1lpR.KpcR0FpvRFH6bTLdtOv4SJHRGng/PeW', 'a0000000-0000-0000-0000-000000000001'),
  ('c0000000-0000-0000-0000-000000000004', 'drfernando@uok.lk', 'Dr. Ruwan Fernando', 'teacher', '$2b$10$jmX9QF7SmhpTc7fqc1lpR.KpcR0FpvRFH6bTLdtOv4SJHRGng/PeW', 'a0000000-0000-0000-0000-000000000001');
...
-- Parent users
insert into users (id, email, full_name, role, password_hash, school_id) values
  ('e0000000-0000-0000-0000-000000000001', 'mbandara@gmail.com', 'Mahinda Bandara', 'parent', '$2b$10$jmX9QF7SmhpTc7fqc1lpR.KpcR0FpvRFH6bTLdtOv4SJHRGng/PeW', 'a0000000-0000-0000-0000-000000000001'),
  ('e0000000-0000-0000-0000-000000000002', 'sjayawardena@gmail.com', 'Sriya Jayawardena', 'parent', '$2b$10$jmX9QF7SmhpTc7fqc1lpR.KpcR0FpvRFH6bTLdtOv4SJHRGng/PeW', 'a0000000-0000-0000-0000-000000000001');
...
-- Courses
-- ============================================================
insert into courses (id, school_id, teacher_id, academic_year_id, name, subject, grade_level, credit_hours) values
...
-- Parent Links
-- ============================================================
insert into parent_links (id, parent_user_id, student_id, relationship) values
  ('ee000000-0000-0000-0000-000000000001', 'e0000000-0000-0000-0000-000000000001', 'f0000000-0000-0000-0000-000000000001', 'father'),
  ('ee000000-0000-0000-0000-000000000002', 'e0000000-0000-0000-0000-000000000002', 'f0000000-0000-0000-0000-000000000002', 'mother');
...
insert into notifications (id, recipient_id, type, title, body, is_read, created_at) values
  ...
  (
    ...
    'warning',
    'Student risk alert',
    'Ashan remains stable, but the system recommends continued parental monitoring ahead of the next midterm cycle.',
    true,
...
insert into users (id, email, full_name, role, password_hash, school_id) values
  ('e0000000-0000-0000-0000-000000000003', 'nperis@gmail.com', 'Nadeesha Peris', 'parent', '$2b$10$jmX9QF7SmhpTc7fqc1lpR.KpcR0FpvRFH6bTLdtOv4SJHRGng/PeW', 'a0000000-0000-0000-0000-000000000001'),
  ('e0000000-0000-0000-0000-000000000004', 'ssenanayake@gmail.com', 'Sulochana Senanayake', 'parent', '$2b$10$jmX9QF7SmhpTc7fqc1lpR.KpcR0FpvRFH6bTLdtOv4SJHRGng/PeW', 'a0000000-0000-0000-0000-000000000001'),
  ('e0000000-0000-0000-0000-000000000005', 'ajayasuriya@gmail.com', 'Anura Jayasuriya', 'parent', '$2b$10$jmX9QF7SmhpTc7fqc1lpR.KpcR0FpvRFH6bTLdtOv4SJHRGng/PeW', 'a0000000-0000-0000-0000-000000000001'),
  ('e0000000-0000-0000-0000-000000000006', 'lwick@gmail.com', 'Lakmali Wickremasinghe', 'parent', '$2b$10$jmX9QF7SmhpTc7fqc1lpR.KpcR0FpvRFH6bTLdtOv4SJHRGng/PeW', 'a0000000-0000-0000-0000-000000000001');
...
insert into parent_links (id, parent_user_id, student_id, relationship) values
  ('ee000000-0000-0000-0000-000000000003', 'e0000000-0000-0000-0000-000000000003', 'f0000000-0000-0000-0000-000000000009', 'mother'),
  ('ee000000-0000-0000-0000-000000000004', 'e0000000-0000-0000-0000-000000000004', 'f0000000-0000-0000-0000-000000000010', 'mother'),
  ('ee000000-0000-0000-0000-000000000005', 'e0000000-0000-0000-0000-000000000005', 'f0000000-0000-0000-0000-000000000011', 'father'),
  ('ee000000-0000-0000-0000-000000000006', 'e0000000-0000-0000-0000-000000000006', 'f0000000-0000-0000-0000-000000000012', 'mother');
...
insert into notifications (id, recipient_id, type, title, body, is_read, created_at) values
  ...
  ('fb000000-0000-0000-0000-000000000017', 'e0000000-0000-0000-0000-000000000003', 'attendance', 'Attendance summary available', 'A fresh attendance summary is available for Shehan Peris.', true, '2026-01-15 13:00:00+00'),
  ('fb000000-0000-0000-0000-000000000018', 'e0000000-0000-0000-0000-000000000005', 'warning', 'Academic support recommended', 'Ravindu would benefit from immediate calculus tutoring support this week.', false, '2026-01-15 13:10:00+00');